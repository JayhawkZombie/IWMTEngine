...
unsigned int LightPlayer2::getPattLength()const
{
    ...
    switch(funcIdx) {
        case 0: return 1;  // All off
        case 1: return numLts;  // Scroll right
        case 2: return numLts;  // Scroll left
        case 3: return numLts;  // Fill from right
        case 4: return numLts;  // Fill from left
        case 5: return numLts;  // Criss cross
        case 6: return pattData[ patternIter ].param;  // Alternate blink
        case 7: return pattData[ patternIter ].param;  // Checker blink
        case 10: return cols;  // Scroll column right
        case 11: return cols;  // Scroll column left
        case 12: return rows;  // Scroll row bottom
        case 13: return rows;  // Scroll row top
        case 14: return cols/2;  // Scroll box in
        case 15: return cols/2;  // Scroll box out
        case 16: return rows + cols;  // Scroll diagonal
        case 100: return BA.bitSize()/numLts;  // From bit array
        default: return 1;  // Unknown pattern
    }
}
